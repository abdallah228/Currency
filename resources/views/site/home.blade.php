...
<head>
    ...
    <!-- Pogo Slider CSS -->
    <link rel="stylesheet" href="{{ asset('asset/css/pogo-slider.min.css') }}" />
    <!-- Site CSS -->
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="pogoSlider" id="js-main-slider">
                    <div class="pogoSlider-slide" style="background-image:url({{ asset('asset/images/slide_img.png') }});">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="full text_align_right_img">
                        <img src="{{ asset('asset/images/img1.png') }}" alt="#" />
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="full services_blog">
                       <img class="img-responsive" src="{{ asset('asset/images/s1.png') }}" alt="#" />
                       <h4>Safe & Secure</h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="full services_blog">
                        <img class="img-responsive" src="{{ asset('asset/images/s2.png') }}" alt="#" />
                        <h4>Mobile Apps</h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="full services_blog">
                        <img class="img-responsive" src="{{ asset('asset/images/s3.png') }}" alt="#" />
                        <h4>Wallet</h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="full services_blog">
                        <img class="img-responsive" src="{{ asset('asset/images/s4.png') }}" alt="#" />
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6" style="background: #fff;">
                    <div class="full text_align_right_img">
                        <img src="{{ asset('asset/images/img2.png') }}" alt="#" />
                    </div>
                </div>
                <div class="col-md-6 layout_padding">
                    <div class="full paddding_left_15">
    ...
    <div class="section layout_padding about_bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="full text_align_right_img">
                        <img src="{{ asset('asset/images/img3.png') }}" alt="#" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                       <img class="img-responsive" src="{{ asset('asset/images/b1.png') }}" alt="#" />
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        <img class="img-responsive" src="{{ asset('asset/images/b2.png') }}" alt="#" />
                        <div class="overlay"><a class="main_bt transparent" href="#">View</a></div>
                       <div class="blog_details">
                         <h3>Ethereum News</h3>
                         <p>pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="full news_blog">
                        <img class="img-responsive" src="{{ asset('asset/images/b3.png') }}" alt="#" />
                        <div class="overlay"><a class="main_bt transparent" href="#">View</a></div>
                       <div class="blog_details">
                         <h3>Light News</h3>
                         <p>pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
    ...
    <script src="{{ asset('asset/js/jquery.pogo-slider.min.js') }}"></script>
    <script src="{{ asset('asset/js/slider-index.js') }}"></script>
